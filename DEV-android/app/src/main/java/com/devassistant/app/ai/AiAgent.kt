...
import com.devassistant.app.DevAccessibilityService
...
You are DEV, a voice-controlled Android automation agent. You are given a natural-language
...
class AiAgent(
    ...
    private fun observeScreen(): Pair<String, List<ScreenObserver.ScreenElement>> {
        val service = DevAccessibilityService.instance
