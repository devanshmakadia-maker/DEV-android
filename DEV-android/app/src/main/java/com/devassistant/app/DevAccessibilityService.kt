...
/**
 * Bound Accessibility Service. This is the ONLY mechanism DEV uses to read screen content and
 ...
 */
class DevAccessibilityService : AccessibilityService() {
    ...
    companion object {
        ...
        var instance: DevAccessibilityService? = null
            private set
    }
